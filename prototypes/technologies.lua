...
baketorio.techPrereqs = {
    ["logistic-science-pack"] = { "baking" },
    ["chemical-science-pack"] = { "cocoa", "frying", "cheese" },
    ["utility-science-pack"] = { "cinnamon", "blueberries" },
    ["production-science-pack"] = { "advanced-baking", "pie", "chocolate-chips", "ice-cream" },
    ["rocket-silo"] = { "nutrient6" }
}

-- Recipe for hardtack added as an unlock
table.insert(
    data.raw.technology["automation-science-pack"].effects,
    { type = "unlock-recipe", recipe = "automation-science-pack-hardtack" }
)
...
baketorio.setSciencePrerequisites()
